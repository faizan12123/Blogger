...
CREATE TABLE `blogs` (
  ...
  KEY `FK1` (`created_by`),
  CONSTRAINT `FK1` FOREIGN KEY (`created_by`) REFERENCES `user` (`username`)
...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`posted_by`) REFERENCES `user` (`username`),
...
CREATE TABLE `follows` (
  ...
  CONSTRAINT `follows_ibfk_1` FOREIGN KEY (`leadername`) REFERENCES `user` (`username`),
  CONSTRAINT `follows_ibfk_2` FOREIGN KEY (`followername`) REFERENCES `user` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hobbies` (
  ...
  CONSTRAINT `hobbies_ibfk_1` FOREIGN KEY (`username`) REFERENCES `user` (`username`),
